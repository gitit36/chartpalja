...
function Ol({ children }: { children: React.ReactNode }) {
  return <ol className="list-decimal pl-5 space-y-1.5 text-sm text-cp-text leading-relaxed">{children}</ol>
}
  ...
  return (
    <LegalPageLayout title="이용약관" effectiveDate={B.termsEffectiveDate}>
      ...
      <Ol>
        ...
        <li>이미 해설 사용에 1회 이상 사용한 이용권 또는 무료 적립·이벤트 등으로 제공된 유료 구입분이 아닌 이용권은 환불이 제한됩니다.</li>
