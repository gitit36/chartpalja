...
export default function RefundPage() {
  return (
    <LegalPageLayout title="환불정책" effectiveDate={B.refundEffectiveDate}>
      <H2>1. 서비스 제공 기간</H2>
      <P>
        본 서비스의 이용권은 비실물(디지털) 상품으로, {B.serviceDeliveryPeriod}. 결제가 완료되면 구매한 이용권이 회원 계정에 자동 지급되어 즉시 해설 기능을 이용하실 수 있습니다. (서비스 제공기간: {B.serviceProvisionWindow})
      </P>

      <H2>2. 이용권의 사용처 및 성격</H2>
      <Ul>
