    ...
    <BottomSheet
      ...
      header={(
        <div className="pt-1 pb-2 text-center">
          ...
          <p className="text-sm text-gray-500">관계 유형을 선택해 주세요</p>
        </div>
      )}
      footer={(
        <div>
          ...
          <div className="flex gap-3">
            ...
            {alreadyExists ? (
              <button
                ...
                className="flex-1 py-3 rounded-xl text-sm font-bold text-purple-700 bg-purple-50 border border-purple-200 hover:bg-purple-100 transition-colors min-h-[48px]"
              >
                해설 보기
              </button>
            ) : (
              <button
                ...
                className="flex-1 py-3 rounded-xl text-sm font-bold text-white bg-gradient-to-r from-purple-600 to-indigo-600 hover:shadow-lg transition-all active:scale-[0.98] min-h-[48px]"
              >
                생성하기
              </button>
            )}
