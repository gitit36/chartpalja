...
# ──────────────────────────────────────────────
# 직업 컬럼은 과거 10개 십성 전부 양수(평균 +0.36)여서 천간+지장간 합산 시
# 모든 사주가 직업운 천장(10)에 포화됐다. 명리 원칙에 맞춰 부호를 재배분한다:
#  - 상관: 상관견관(傷官見官) → 정관(직장·조직) 극 → 직업 부정
#  - 편인: 도식(倒食) → 식신 극, 직업 불안정·이직 → 직업 부정
#  - 겁재: 탈재·경쟁·동업갈등 → 직업 약한 부정
#  - 정관/편관: 관성=직업·명예의 본질 → 양수 유지(정관 최대)
# 결과적으로 직업 컬럼 평균(+0.09)이 타 도메인과 균형을 이룬다.
_TG_DOM = {
    "비견":{"직업":0.1,"재물":-0.2,"건강":0.1,"연애":-0.1,"결혼":-0.1},
    "겁재":{"직업":-0.2,"재물":-0.4,"건강":0.0,"연애":-0.2,"결혼":-0.3},
    "식신":{"직업":0.2,"재물":0.3,"건강":0.5,"연애":0.3,"결혼":0.2},
    "상관":{"직업":-0.3,"재물":0.2,"건강":0.0,"연애":0.4,"결혼":-0.2},
    "편재":{"직업":0.1,"재물":0.5,"건강":0.0,"연애":0.5,"결혼":0.1},
    "정재":{"직업":0.1,"재물":0.6,"건강":0.0,"연애":0.2,"결혼":0.5},
    "편관":{"직업":0.3,"재물":-0.1,"건강":-0.3,"연애":0.1,"결혼":-0.2},
    "정관":{"직업":0.5,"재물":0.2,"건강":0.0,"연애":0.1,"결혼":0.4},
    "편인":{"직업":-0.1,"재물":-0.1,"건강":0.1,"연애":0.0,"결혼":-0.1},
    "정인":{"직업":0.2,"재물":0.1,"건강":0.3,"연애":0.0,"결혼":0.2},
}
_GEOK_DOM = {
